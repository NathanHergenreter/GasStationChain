...
public class Cashier extends Employee {
	...
	public Cashier(String username, String password, String name, int wagesHourly, int hoursWeekly) {
	...
	public Cashier(String name, int wagesHourly, int hoursWeekly) {
		super((name.replace(' ', '_') + (Integer.valueOf(wagesHourly + hoursWeekly + name.length())).toString()),
				"password");
		this.name = name;
		this.wagesHourly = wagesHourly;
		this.hoursWeekly = hoursWeekly;
	...
	public Cashier addAvailability(Availability availability) {
